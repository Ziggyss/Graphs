...
# This is Tom's solution but I have a few questions:
...
def earliest_ancestor(ancestors, starting_node):
    ...
    # Do a BFS (with paths)
    # Question for Pascal: Why not use DFS in this situation?
    # create a queue
    q = Queue()
    ...
    # Question for Pascal: I don't fully understand line 59?
    earliest_ancestor = -1
